Public Class Game
    ...
    Protected Score = GrazeCount \ 7 ^ (Lives + Bombs / 2)
    ...
    Protected ToriiGate1 As Rectangle = New Rectangle(100, 100, ToriiSize.Width, ToriiSize.Height)
    Protected ToriiGate2 As Rectangle = New Rectangle(700, 100, ToriiSize.Width, ToriiSize.Height)
    ...
    Protected Overloads Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Else
            g.DrawImage(ChangeOpacity(My.Resources.torii, OpacityTickCount / 3000), 100, 200)
            g.DrawImage(ChangeOpacity(My.Resources.torii, OpacityTickCount / 3000), 600, 200)
        End If
        ...
        g.DrawString(GrazeCount \ 3, ScoreboardFont, Brushes.HotPink, 1085, 393)
    ...
    Protected Sub RunningTime_Tick(sender As Object, e As EventArgs) Handles RunningTime.Tick
        ...
        If Not Character.IntersectsWith(New Rectangle(50, 0, 0, 720)) Then
            ...
            End If
        End If
        If Not Character.IntersectsWith(New Rectangle(942, 60, 0, 720)) Then
            If BoolRight Then
                If BoolShift Then
                    Character.X += 5
                    Hitbox.X += 5
        ...
        If Bullets IsNot Nothing Then
            For Each Bullet In Bullets
                ...
                If Bullet.CurrentPos.Y < 60 OrElse Bullet.CurrentPos.Y > 630 OrElse Bullet.CurrentPos.X > 910 OrElse Bullet.CurrentPos.X < 50 Then
                    BulletsDummy.Add(Bullet)
                ...
                End If
                If BulletHitbox.IntersectsWith(Hitbox) AndAlso CharacterCooldown.ElapsedMilliseconds > 3000 Then
                    CharacterCooldown = Stopwatch.StartNew()
                    Lives -= 1
                ElseIf BulletHitbox.IntersectsWith(Character) Then
                    GrazeCount += 1
                End If
            Next
    ...
    Protected Sub Shooting(sender As Object, e As EventArgs) Handles ShootingCD.Tick
        ...
        If BoolShift And BoolUp Then
            Enemies.Add(New Parrot(New Point(50, 50), traj, 10, 5))
        End If
